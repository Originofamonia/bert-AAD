...
import param
from train import pretrain, evaluate, centroid_compute, target_gmm, src_tgt_free_adapt
...
def main():
    ...
    centroid_compute(args, src_encoder, src_classifier, src_loader)
    t_feature_dict = target_gmm(args, tgt_encoder, tgt_all_loader, 1)

    # train target encoder by GAN
    print("=== Training encoder for target domain ===")
    if args.adapt:
        tgt_encoder.load_state_dict(src_encoder.state_dict())
        tgt_encoder = src_tgt_free_adapt(args, src_encoder, tgt_encoder, discriminator,
